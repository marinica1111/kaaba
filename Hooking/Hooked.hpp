...
namespace Hooked
{
	...
	inline FindMaterialFn oFindMaterial;
	IMaterial* __fastcall FindMaterial( void* ecx, void* edx, char const* pMaterialName, const char* pTextureGroupName, bool complain = true, const char* pComplainPrefix = NULL );
	...
	typedef void( __thiscall* fnCalcView )( void*, int, int, int, int, int );
	inline fnCalcView oCalcView;
	void __fastcall CalcView( void* ecx, void* edx, int a3, int a4, int a5, int a6, int a7 );

	typedef void( __thiscall* fnComputeShadowDepthTextures )( void*, const CViewSetup&, bool );
	inline fnComputeShadowDepthTextures oComputeShadowDepthTextures;
	void __fastcall ComputeShadowDepthTextures( void* ecx, void* edx, const CViewSetup& view, bool a4 );

	typedef void( __thiscall* fnDrawLightDebuggingInfo )( void* );
	inline fnDrawLightDebuggingInfo oDrawLightDebuggingInfo;
	void __fastcall DrawLightDebuggingInfo( void* ecx, void* edx );
	...
	void m_angEyeAngles( const CRecvProxyData* pData, void* pStruct, void* pOut );
}
